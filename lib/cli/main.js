...
var npccoincorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = npccoincorenode.version;
  var create = npccoincorenode.scaffold.create;
  var add = npccoincorenode.scaffold.add;
  var start = npccoincorenode.scaffold.start;
  var remove = npccoincorenode.scaffold.remove;
  var callMethod = npccoincorenode.scaffold.callMethod;
  var findConfig = npccoincorenode.scaffold.findConfig;
  var defaultConfig = npccoincorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the NPCcoin database directory')
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with NPCcoincore Node configuration')
    .option('-d, --daemon', 'Make npccoincore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `npccoincore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ npccoincore-node add wallet-service');
      console.log('    $ npccoincore-node add insight-api-npccoin');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ npccoincore-node remove wallet-service');
      console.log('    $ npccoincore-node remove insight-api-npccoin');
      console.log();
    });
