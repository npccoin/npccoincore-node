...
describe('#remove', function() {
  ...
  before(function(done) {
    mkdirp(testDir + '/s0/s1', function(err) {
      ...
      fs.writeFile(
        testDir + '/s0/s1/npccoincore-node.json',
  ...
  describe('will modify scaffold files', function() {
    ...
    it('will update npccoincore-node.json services', function(done) {
      ...
      removetest({
        ...
        var configPath = path.resolve(testDir, 's0/s1/npccoincore-node.json');
